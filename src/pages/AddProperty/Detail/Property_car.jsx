		...
		<>
			<div className='AddInsurance'>
				<div className='AddInsuranceFame1'>
					...
					<p className='HTextAddInsuranceFame1_2'>{'>'}</p>
					<p className='HTextAddInsuranceFame1_2'>ทรัพย์สินประเภทรถยนต์และยานพาหนะ</p>
				</div>

				<div className='AddInsuranceFame2'>
					<p className='HTextAddInsuranceFame26'>เพิ่มข้อมูลทรัพย์สินประเภทรถยนต์ ยานพาหนะ</p>
					...
					<div className='formPersonalFame2_4'>
						<label>
							<p className='labelformAddInsuranceFame2_1'>ประเภททรัพย์สิน</p>
							<Select
						...
						<label>
							<p className='labelformAddInsuranceFame2_1'>สิทธิในทรัพย์</p>
							<Select
								className='basic-single'
								classNamePrefix='select'
								defaultValue={''}
						...
						<label>
							<p className='labelformAddInsuranceFame2_1'>ยี่ห้อ</p>
							<Select
								className='basic-single'
								classNamePrefix='select'
								defaultValue={''}
						...
						<label>
							<p className='labelformAddInsuranceFame2_1'>ปีที่ผลิต</p>
							<Select
								className='basic-single'
								classNamePrefix='select'
								defaultValue={''}
					...
					<div style={styles.TextTop}>
						...
						>
							<div style={{display: 'flex', flex: 1, flexDirection: 'column'}}>
								<div style={styles.textTitle}>รุ่น</div>
								<div style={{flexDirection: 'row', display: 'flex', marginRight: '10px'}}>
									<input style={styles.TextInputsCar} defaultValue={''} placeholder={'ใส่รุ่นรถ'} />
								</div>
							</div>
							<div style={{display: 'flex', flex: 1, flexDirection: 'column'}}>
								<div style={{...styles.textTitle, marginLeft: '5%'}}>จังหวัดที่จดทะเบียนรถ</div>
								<div style={{flexDirection: 'row', display: 'flex', justifyContent: 'center', marginRight: '10px'}}>
									<input style={styles.TextInputsCar} defaultValue={''} placeholder={'XXX'} />
								</div>
							</div>
							<div style={{display: 'flex', flex: 1, flexDirection: 'column'}}>
								<div style={{...styles.textTitle, marginLeft: '10%'}}>ทะเบียนรถ</div>
								<div style={{flexDirection: 'row', display: 'flex', justifyContent: 'flex-end'}}>
									<input style={styles.TextInputsCar} defaultValue={''} placeholder={'ใส่เลขทะเบียนรถ'} />
								</div>
							</div>
						</div>
					</div>
					...
					<div style={styles.TextTop}>
						...
						<div>
							<textarea
								...
								defaultValue={''}
								placeholder={'ภาระติดผัน เช่น จดจํานองไว้นายเกษตรไถ่ถอน ต้องจ่าย200,000บาท'}
							/>
						</div>
					</div>
					{/* 1 row */}
					<div style={styles.TextTop}>
						<div style={styles.textTitle}>มูลมูลค่ายานพาหนะโดยประมาณ</div>
						<div>
					...
					{/* 1 row */}
					<div style={styles.TextTop}>
						<div style={styles.textTitle}>จอดไว้ที่ไหน</div>
						<div>
							<input style={styles.TextInputs} defaultValue={''} placeholder={'ระบุสถานที่จอดของยานพาหนะ'} />
						</div>
					</div>
					{/* 1 row */}
					<div style={styles.TextTop}>
