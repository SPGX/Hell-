		...
		<>
			<div className='AddInsurance'>
				<div className='AddInsuranceFame1'>
					...
					<p className='HTextAddInsuranceFame1_2'>{'>'}</p>
					<p className='HTextAddInsuranceFame1_2'>ทรัพย์สินประเภทสินค้า Luxury</p>
				</div>

				<div className='AddInsuranceFame2'>
					<p className='HTextAddInsuranceFame26'>เพิ่มข้อมูลทรัพย์สินประเภทสินค้า Luxury</p>
						...
						>
							<div style={{display: 'flex', flex: 1, flexDirection: 'column'}}>
								...
								<div style={{flexDirection: 'row', display: 'flex', marginRight: '10px'}}>
									<input style={styles.TextInputsCar} defaultValue={''} placeholder={'นาฬิกา'} />
								</div>
							</div>
							<div style={{display: 'flex', flex: 1, flexDirection: 'column'}}>
								<div style={{...styles.textTitle, marginLeft: '5%'}}>ยี่ห้อ</div>
								<div style={{flexDirection: 'row', display: 'flex', justifyContent: 'center', marginRight: '10px'}}>
									<input style={styles.TextInputsCar} defaultValue={''} placeholder={'ยี่ห้อสินค้า'} />
								</div>
							</div>
							<div style={{display: 'flex', flex: 1, flexDirection: 'column'}}>
								<div style={{...styles.textTitle, marginLeft: '10%'}}>รุ่น</div>
								<div style={{flexDirection: 'row', display: 'flex', justifyContent: 'flex-end'}}>
									<input style={styles.TextInputsCar} defaultValue={''} placeholder={'รุ่นสินค้า'} />
								</div>
							</div>
						</div>
					</div>
...
export default Property_luxury;
