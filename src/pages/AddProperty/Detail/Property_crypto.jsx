		...
		<>
			<div className='AddInsurance' style={{padding: windowSize[0] > 1000 ? '15%' : '0%', paddingTop: '10px'}}>
				<div className='AddInsuranceFame1'>
					...
					<p className='HTextAddInsuranceFame1_2'>{'>'}</p>
					<p className='HTextAddInsuranceFame1_2'>ทรัพย์สินประเภทคริปโตคอยน์</p>
				</div>

				<div className='AddInsuranceFame2'>
					<p className='HTextAddInsuranceFame26'>เพิ่มข้อมูลทรัพย์สินประเภทคริปโตคอยน์</p>
					...
					{/* 1 row */}
					<div style={styles.TextTop}>
						<div style={styles.textTitle}>สถานที่เก็บทรัพย์สิน</div>
						<div>
							<input style={styles.TextInputs} defaultValue={''} placeholder={'Exchange/Wallet'} />
						</div>
					</div>
					{/* 1 row */}
					<div style={styles.TextTop}>
						<div style={styles.textTitle}>มูลค่าคริปโตโดยประมาณ</div>
						<div>
							<input style={styles.TextInputs} defaultValue={''} placeholder={'ใส่มูลค่า คริปโต โดยประมาณ'} />
						</div>
					</div>
					{/* 1 row */}
					<div style={styles.TextTop}>
...
export default Property_crypto;
