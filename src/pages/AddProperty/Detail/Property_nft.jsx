		...
		<>
			<div className='AddInsurance'>
				<div className='AddInsuranceFame1'>
					...
					<p className='HTextAddInsuranceFame1_2'>{'>'}</p>
					<p className='HTextAddInsuranceFame1_2'>ทรัพย์สินประเภทNFT</p>
				</div>

				<div className='AddInsuranceFame2'>
					<p className='HTextAddInsuranceFame26'>เพิ่มข้อมูลทรัพย์สินประเภทNFT</p>
					...
					<div style={styles.TextTop}>
						<div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', flex: 1}}>
							<div style={{display: 'flex', flex: 0.45, flexDirection: 'column'}}>
								<div style={styles.textTitle}>ชื่อ NFT</div>
								<input style={styles.TextInputs} defaultValue={''} placeholder={'ชื่อ NFT ที่คุณครอบครอง'} />
							</div>
							<div style={{display: 'flex', flex: 0.45, flexDirection: 'column'}}>
								<div style={styles.textTitle}>ประเภททรัพย์สิน</div>
								<input style={styles.TextInputs} defaultValue={''} placeholder={'ศิลปะ'} />
							</div>
						</div>
					</div>
					{/* 1 row */}
					<div style={styles.TextTop}>
						<div style={styles.textTitle}>Contract Address</div>
						<div>
							<input style={styles.TextInputs} defaultValue={''} placeholder={'URL link แหล่งของ NFT'} />
						</div>
					</div>
					{/* 1 row */}
					<div style={styles.TextTop}>
						<div style={styles.textTitle}>Blockchain</div>
						<div>
							<input style={styles.TextInputs} defaultValue={''} placeholder={'ใส่สกุล Blockchain'} />
						</div>
					</div>
					{/* 1 row */}
					<div style={styles.TextTop}>
						<div style={styles.textTitle}>มูลค่า NFT โดยประมาณ</div>
						<div>
							<input style={styles.TextInputs} defaultValue={''} placeholder={'ใส่มูลค่า NFT โดยประมาณ'} />
						</div>
					</div>
					{/* 1 row */}
					<div style={styles.TextTop}>
