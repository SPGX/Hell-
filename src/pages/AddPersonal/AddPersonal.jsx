...
const AddPersonal = () => {
	...
	const handleX = DistrictThaiShort => {
		const DistrictThai = [...new Set(DistrictThaiShort?.map(item => item.DistrictThaiShort))];
	...
	const ProvinceThai = [...new Set(arrayOfObj4.map(item => item.ProvinceThai))];
	...
	async function createPerson(event) {
		...
		let format3 = form.get('Year') + '-' + form.get('Month') + '-' + form.get('Day');
							...
							<form as='form' onSubmit={createPerson}>
								...
								<div className='formPersonalFame2_2'>
									...
									<div className='formPersonalFame2_3'>
										...
										<label>
											<p className='labelformAddPersonalFame2'>นามสกุล</p>
											<input className='inputformAddPersonalFame2_2_1' name='MarLname' placeholder={'นามสกุล'} />
										</label>
									</div>
									<div className='formPersonalFame2_1'>
										<label>
								...
								<div className='formPersonalFame2_1'>
									<label>
										<p className='labelformAddPersonalFame2'>มูลค่าทรัพย์สินโดยรวม</p>
